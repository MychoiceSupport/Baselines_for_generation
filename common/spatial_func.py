...
def distance(a, b):
    ...
    # _lat, _lng = b.lat, b.lng
    # b.lat, b.lng = a.lat, a.lng
    # a.lat, a.lng = _lat, _lng
    if same_coords(a, b):
        return 0.0
...
def point_bearing(a, b):
    """
    :param a:[lat, lot]
    :param b:[lat, lot]
    :return:
    """
    pt_a_lat_rad = math.radians(a[0])
    pt_a_lng_rad = math.radians(a[1])
    pt_b_lat_rad = math.radians(b[0])
    pt_b_lng_rad = math.radians(b[1])
    y = math.sin(pt_b_lng_rad - pt_a_lng_rad) * math.cos(pt_b_lat_rad)
...
def project_pt_to_segment_point(a, b, t):
    """
    Args:
    -----
    a,b: start/end GPS location of a road segment, STPoint
    t: raw point, lat, lng
    Returns:
    -------
    ...
    ab_angle = point_bearing(a, b)
    at_angle = point_bearing(a, t)
    ab_length = point_distance(a, b)
    at_length = point_distance(a, t)
