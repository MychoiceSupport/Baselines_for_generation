from common.spatial_func import distance, SPoint, cal_loc_along_line
...
class STPoint(SPoint):
    ...
    def __str__(self):
        ...
        # key and value of self attributes
...
class Trajectory:
    ...
    def get_all_time(self):
        return [[data.lat,data.lng] for data in self.pt_list]
    def get_all_time(self):
        return [data.time for data in self.pt_list]
